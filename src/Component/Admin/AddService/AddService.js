                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="d-flex">
                                <div className="form-group" style={{ width: "500px" }}>
                                    ...
                                    <input onBlur={handleBlur} className="form-control form-control-lg" type="text" name="title" placeholder="Enter Title" />
                                </div>
                                <div className="form-group ml-3">
                                    <label className="font-weight-bold">Icon</label><br />
                                    <input onChange={handleFileChange} className="form-conrol-lg" type="file" name="icon" />
                                </div>
                            </div>
                            <div style={{ width: "500px" }} className="form-group">
                                <label className="font-weight-bold">Description</label>
                                <textarea onBlur={handleBlur} className="form-control form-control-lg" name="description" placeholder="Enter Description" cols="10" rows="5"></textarea>
                            </div>

                    ...
                    <div className="col-md-7 ml-5">
                        <form>
                            <div className="form-group">
                                <input type="email" placeholder="Your email address" className="form-control form-control-lg" />
                            </div>
                            <div className="form-group">
                                <input type="text" placeholder="Your name / comapny's name" className="form-control form-control-lg" />
                            </div>
                            <div className="form-group">
                                <textarea name="" id="" cols="15" rows="5" className="form-control form-control-lg" placeholder="Your Message"></textarea>
                            </div>
                            <div>
